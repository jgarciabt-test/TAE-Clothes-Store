...
public class MainActivity extends Activity {
	...
	ImageView asthmaActionPlan, controlledMedication, asNeededMedication,
...
//		next = (LinearLayout) findViewById(R.id.next);
		...
		asthmaActionPlan = (ImageView) findViewById(R.id.asthma_action_plan);
		controlledMedication = (ImageView) findViewById(R.id.controlled_medication);
		asNeededMedication = (ImageView) findViewById(R.id.as_needed_medication);
		rescueMedication = (ImageView) findViewById(R.id.rescue_medication);
		yourSymtoms = (ImageView) findViewById(R.id.your_symptoms);
		yourTriggers = (ImageView) findViewById(R.id.your_triggers);
		wheezeRate = (ImageView) findViewById(R.id.wheeze_rate);
		peakFlow = (ImageView) findViewById(R.id.peak_flow);
		...
		viewWidth = mWidth / 3;
		layouts = new ArrayList<ImageView>();
	...
	class MyGestureDetector extends SimpleOnGestureListener {
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			horizontalScrollView.smoothScrollTo(layouts.get(currPosition)
					.getLeft(), 0);
			mainPicture.setImageDrawable(layouts.get(currPosition).getDrawable());
			return true;
		}
	}
